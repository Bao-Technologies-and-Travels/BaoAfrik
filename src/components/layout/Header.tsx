                    ...
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-3 z-50">
                      ...
                      <div className="py-2">
                        ...
                        <button
                          ...
                          className={`w-full flex items-center px-4 py-2 text-sm transition-colors duration-200 ${selectedLanguage === 'DE'
                            ? 'bg-blue-50 text-blue-600'
                            : 'text-gray-700 hover:bg-gray-50'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`w-full flex items-center px-4 py-2 text-sm transition-colors duration-200 ${selectedLanguage === 'ES'
                            ? 'bg-blue-50 text-blue-600'
                            : 'text-gray-700 hover:bg-gray-50'
                            }`}
                        >
