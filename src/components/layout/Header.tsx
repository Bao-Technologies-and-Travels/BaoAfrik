              ...
              {user ? (
                ...
                <>
                  ...
                  <button
                    ...
                    style={{ color: "#F9A822" }}
                    onMouseEnter={(e) =>
                      ((e.target as HTMLElement).style.color = "#E6941F")
                    }
                    onMouseLeave={(e) =>
                      ((e.target as HTMLElement).style.color = "#F9A822")
                    }
                    aria-label="Toggle navigation menu"
                    aria-expanded={isMobileMenuOpen}
                  >
            ...
            <div className="md:hidden fixed inset-0 bg-white z-50 flex flex-col">
              ...
              <div className="flex justify-between items-center p-4 flex-shrink-0">
                ...
                <div className="flex items-center">
                  <img src={logoPre} alt="bao'Afrik" className="h-8 w-auto" />
                </div>
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-500">
                              Check your discussions in your inbox
                            </div>
                          </div>
                        </div>
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-500">
                              Don't miss anything about your activities
                            </div>
                          </div>
                        </div>
                        <div className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center">
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-500">
                              Publish and manage your articles better
                            </div>
                          </div>
                        </div>
                        <div className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center">
